...
In section \ref{sec:related} we review related work and position our paper. Section \ref{sec:background} introduces the background of the paper and formalizes the problem setting. Section \ref{sec:objectives} defines the objectives of the proposed solution. Section \ref{sec:design} describes the development and implementation of the prototype. Section \ref{sec:evaluation} reports the evaluation. Section \ref{sec:discussion} discusses the implications and limitations, and Section \ref{sec:conclusion} concludes with the directions for future research.
